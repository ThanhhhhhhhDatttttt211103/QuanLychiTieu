...
public class FormSuaChi extends JFrame {
	...
	public FormSuaChi(User user, Transaction transaction, String name) {
		this.user = user;
	...
	public void init() {
		...
		SuaChiController ac = new SuaChiController(this);
		...
		JLabel txtChinhSua = new JLabel("Chỉnh sửa khoản chi");
