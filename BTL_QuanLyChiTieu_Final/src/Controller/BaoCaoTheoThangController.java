...
public class BaoCaoTheoThangController implements ActionListener, WindowListener {
	private  FormBaoCaoTheoThang baocao;
	
	public BaoCaoTheoThangController(FormBaoCaoTheoThang baocao) {
		this.baocao = baocao;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btn.getName().equals("up")) {
			...
			System.out.println(src);
		}else if(src.equals("Hàng Năm")) {
			baocao.setVisible(false);
			baocao.baoCaoChiTieu();
			try {
				new FormBaoCaoTheoNam(baocao.getUser());
			} catch (InterruptedException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}
