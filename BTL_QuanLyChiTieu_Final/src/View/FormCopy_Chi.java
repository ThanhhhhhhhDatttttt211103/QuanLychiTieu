...
import Controller.Copy_ChiController;
...
public class FormCopy_Chi extends JFrame {
	...
	public FormCopy_Chi(User user, Transaction transaction) {
		this.user = user;
	...
	public void init() {
		...
		Copy_ChiController ac = new Copy_ChiController(this);
		...
		jButton_back.setIcon(new ImageIcon(FormCopy_Chi.class.getResource("/Icon/back32.png")));
