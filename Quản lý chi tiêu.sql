...
-- Dumping data for table quanlychitieu.budget: ~0 rows (approximately)
...
-- Dumping data for table quanlychitieu.category: ~14 rows (approximately)
INSERT INTO `category` (`ID`, `username`, `danhMuc`, `icon`, `loai`) VALUES
	...
	(7, 'thanhdat1', 'Tiền nhà', 'home.png', b'0'),
...
-- Dumping data for table quanlychitieu.transaction: ~51 rows (approximately)
INSERT INTO `transaction` (`ID`, `username`, `danhMuc`, `ngayGiaoDich`, `soTien`, `ghiChu`, `loai`) VALUES
	(16, 'thanhdat1', 'Ăn uống', '2023-04-20', 21000, 'haha', b'0'),
	(17, 'thanhdat1', 'Giáo dục', '2023-04-20', 21000, 'haha', b'0'),
	(19, 'thanhdat1', 'Giáo dục', '2023-04-20', 20000, '', b'0'),
	(20, 'thanhdat1', 'Quần áo', '2023-04-20', 31000, 'thanhdat', b'0'),
	(21, 'thanhdat1', 'Quần áo', '2023-04-17', 31000, 'thanhdat', b'0'),
	(24, 'thanhdat1', 'đớp', '0000-00-00', 200000, NULL, b'0'),
	(27, 'thanhdat1', 'Ăn uống', '2023-05-02', 21312313, '13123', b'0'),
	(28, 'thanhdat1', 'Ăn uống', '2023-06-04', 1000000, 'hoàng con ngu ngốc', b'0'),
	(32, 'thanhdat1', 'Tiền Lương', '2023-04-22', 21321, '2131', b'1'),
	(33, 'thanhdat1', 'Y tế', '2023-04-19', 2000000, 'hehee', b'0'),
	(35, 'thanhdat1', 'Tạm thời', '2023-05-02', 21312313, '13123', b'1'),
	(36, 'thanhdat1', 'Tiền nhà', '2023-04-23', 200000, 'sau khi chỉnh sửa lại 1 chút', b'0'),
	(37, 'thanhdat1', 'Ăn uống', '2023-04-23', 2000000, '', b'0'),
	(45, 'thanhdat1', 'Tạm thời', '2023-04-22', 2307200, 'Copy rồi nè 2', b'1'),
	(46, 'thanhdat1', 'Tiền nhà', '2023-04-24', 10000, 'Hello world', b'0'),
	(48, 'thanhdat1', 'Ăn uống', '2023-04-21', 21000, 'haha', b'0'),
	(49, 'thanhdat1', 'Phụ', '2023-04-22', 21000, 'haha', b'1'),
	...
	(55, 'thanhdat1', 'Ăn uống', '2023-04-24', 0, '4234', b'0'),
	...
	(74, 'thanhdat1', 'Quần áo', '2023-04-26', 20000000, 'test', b'0'),
	...
	(86, 'thanhdat1', 'Chứng khoán', '2023-04-29', 2000000, 'Thêm DAO thu', b'1'),
